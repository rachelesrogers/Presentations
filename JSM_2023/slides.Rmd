...
clean_results_merged$bet<- NA

clean_results_merged[!is.na(clean_results_merged$guilt_bet),]$bet<- clean_results_merged[!is.na(clean_results_merged$guilt_bet),]$guilt_bet

clean_results_merged[!is.na(clean_results_merged$innocent_bet),]$bet<- clean_results_merged[!is.na(clean_results_merged$innocent_bet),]$innocent_bet
