...
Non-Image, Non-Algorithm, Identification
...
Conviction Choice
 - `r round(sum(microstudy_clean[microstudy_clean$conclusion=="Match",]$convict=="Yes")/sum(microstudy_clean$conclusion=="Match")*100, 2)`% in the Identification Condition
 
 - `r round(sum(microstudy_clean[microstudy_clean$conclusion=="NoMatch",]$convict=="Yes")/sum(microstudy_clean$conclusion=="NoMatch")*100, 2)`% in the Elimination Condition
